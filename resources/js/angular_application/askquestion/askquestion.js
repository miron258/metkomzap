ngApp.controller('askQuestionCtrl', ['$scope', '$rootScope', '$compile', '$timeout', '$http', function ($scope, $rootScope, $compile, $timeout, $http) {
...
ngApp.directive('formAskQuestion', ['$http', '$compile', '$rootScope',
    function ($http, $compile, $rootScope) {
        //URK шаблона страницы для текущей директивы
        var templateUrl = '/askquestion';
        return {
