<tr>
    ...
    <td><a target="_blank" href="{{ route('catalog_site.index', $item->url) }}">Перейти на страницу каталога</a></td>
    <td>
        @if($item->index)
    ...
    <td>
        <a class="btn btn-primary btn-sm" href="{{route('catalog.edit', $item->id)}}"> <i class="far fa-edit mr-2"></i>Редактировать</a>
    </td>
    <td>
